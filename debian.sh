...
echo "<pre>Modified by IlhamGanteng</pre>" > /home/vps/public_html/index.html
...
wget -O bench-network.sh "https://raw.githubusercontent.com/IlhamArrouf/IlhamGanteng/master/bench-network.sh"
